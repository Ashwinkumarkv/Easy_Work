                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<td>
                                  <form method="post" action="">
                                      ...
                                      <button type="button" class="complete-button" onclick="toggleFeedbackForm()">Completed</button>
                                  </form>
                                  <div class="feedback-form" id="feedbackForm">
                                      <form method="POST" action="submit_feedback.php">
                                          ...
                                          <label for="feedback" style="margin-bottom: 10px;">Provide Feedback:</label>
                                          <textarea class="feedback-input" name="feedback" id="feedback" ></textarea>
                                          <button type="submit" class="submit-feedback" name="submit_feedback">Submit Feedback</button>
                                      </form>
                                  </div>
                              </td>';
                        echo "</tr>";
